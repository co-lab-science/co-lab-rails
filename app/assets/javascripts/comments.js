  ...
  function initHypothesis() {
    ...
    function attachLikeEvents(node) {
      ...
      $clickNode.on('click', function() {
        ...
        if ($(this).hasClass('highlight-font')) {
          $(this).removeClass('highlight-font')
          var likeCount = parseInt($(this).find('.like-count').html()) - 1
    ...
    function attachDislikeEvents(node) {
      ...
      $clickNode.on('click', function() {
        ...
        if ($(this).hasClass('highlight-font')) {
          $(this).removeClass('highlight-font')
          var dislikeCount = parseInt($(this).find('.dislike-count').html()) - 1
          $(this).find('.dislike-count').html(dislikeCount)
      ...
      $clickNode.on('click', function() {
        ...
        if(!userHasDownvoted) {
          $.ajax({
            type: 'post',
            url: upvotesURL,
            data: { vote_type: "downvote", h_id: commentId, user_id: userid },
            success: function() {
            },
          });
        } else {
