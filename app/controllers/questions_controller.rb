class QuestionsController < ApplicationController
  ...
  private
    ...
    def question_params
      params.require(:question).permit(:hypothesis_id, :user_id, :lab_id, :question_id, :group, :group_id, :title, :body, :parent, comments_attributes: [:id, :title, :body])
    end
end
